...
\end{equation}
where $\alpha_{mn}$ is ..., $h_{mn}(t)$ is..., $\tau_{mn}$ is .... , $v_r$ is
\begin{equation}
...
\end{align}
The quantity $\varsigma_n$ describes ... and $v_{0n}$ .... An example of the sigmoidal activation function .... \dean{Write something about $v_r$ being lumped into $v_0$.}
...
\end{equation}
where $\mathrm{D}$ .... Equation~\ref{eq:2ndOrder} can be written ...
...
\end{equation}
where $z_n(t)$ is .... This forms the basis of a state-space model ....
